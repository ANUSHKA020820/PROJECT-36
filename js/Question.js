class Question {
  ...
  display(){
    ...
    this.option1.position(95, 100);
    this.option2.html("2: Envelope" );
    this.option2.position(95, 120);
    this.option3.html("3: Estimate " );
    this.option3.position(95, 140);
    this.option4.html("4: Example" );
    this.option4.position(95, 160);

    this.input1.position(250, 230);
    this.input2.position(450, 230);
    this.button.position(405, 300);

    this.button.mousePressed(()=>{
      
      this.message.html("YOUR ANSWER WAS SUBMITTED!");
